//app/protected/rephrasing/page.tsx
"use client";
...
export default function Rephrasing() {
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        const chapters = await getChaptersByType("rephrasing");
  ...
  return (
    <div className="container py-8">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Rephrasing</CardTitle>
          <CardDescription>
            Practice rephrasing sentences in different ways.
          </CardDescription>
        </CardHeader>
        <CardContent>
